...
4. For test files (`*.test.*`, `*.spec.*`): apply `skills/testing-strategy` and flag weak assertions (e.g. `toBeTruthy`, `toBeDefined` where a specific shape could be asserted).
...
- `skills/testing-strategy` — for test file audit.
